...
async def RiZoeLX():
    ...
    if STRING:
        ...
        try:
            ...
            await Riz(functions.channels.JoinChannelRequest(channel="@Jatt_0P"))
            await Riz(functions.channels.JoinChannelRequest(channel="@ABOUT_PANDIT"))
    ...
    if STRING2:
        ...
        try:
            ...
            await Riz2.start()
            await Riz2(functions.channels.JoinChannelRequest(channel="@Jatt_0P"))
            await Riz2(functions.channels.JoinChannelRequest(channel="@ABOUT_PANDIT"))
    ...
    if STRING3:
        ...
        try:
            ...
            await  Riz3.start()
            await Riz3(functions.channels.JoinChannelRequest(channel="@Jatt_0P"))
            await Riz3(functions.channels.JoinChannelRequest(channel="@ABOUT_PANDIT"))
    ...
    if STRING4:
        ...
        try:
            ...
            await Riz4.start()
            await Riz4(functions.channels.JoinChannelRequest(channel="@Jatt_0P"))
            await Riz4(functions.channels.JoinChannelRequest(channel="@ABOUT_PANDIT"))
    ...
    if STRING5:
        ...
        try:
            ...
            await Riz5.start()
            await Riz5(functions.channels.JoinChannelRequest(channel="@Jatt_0P"))
            await Riz5(functions.channels.JoinChannelRequest(channel="@ABOUT_PANDIT"))
    ...
    if STRING6:
        ...
        try:
            ...
            await Riz6.start()
            await Riz6(functions.channels.JoinChannelRequest(channel="@Jatt_0P"))
            await Riz6(functions.channels.JoinChannelRequest(channel="@ABOUT_PANDIT"))
    ...
    if STRING7:
        ...
        try:
            ...
            await Riz7.start()
            await Riz7(functions.channels.JoinChannelRequest(channel="@Jatt_0P"))
            await Riz7(functions.channels.JoinChannelRequest(channel="@ABOUT_PANDIT"))
    ...
    if STRING8:
        ...
        try:
            ...
            await Riz8.start()
            await Riz8(functions.channels.JoinChannelRequest(channel="@Jatt_0P"))
            await Riz8(functions.channels.JoinChannelRequest(channel="@ABOUT_PANDIT"))
    ...
    if STRING9:
        ...
        try:
            ...
            await Riz9.start()
            await Riz9(functions.channels.JoinChannelRequest(channel="@Jatt_0P"))
            await Riz9(functions.channels.JoinChannelRequest(channel="@ABOUT_PANDIT"))
    ...
    if STRING10:
        ...
        try:
            ...
            await Riz10.start()
            await Riz10(functions.channels.JoinChannelRequest(channel="@Jatt_0P"))
            await Riz10(functions.channels.JoinChannelRequest(channel="@ABOUT_PANDIT"))
    ...
    if STRING11:
        ...
        try:
            ...
            await Riz11.start()
            await Riz11(functions.channels.JoinChannelRequest(channel="@Jatt_0P"))
            await Riz11(functions.channels.JoinChannelRequest(channel="@ABOUT_PANDIT"))
    ...
    if STRING12:
        ...
        try:
            ...
            await Riz12.start()
            await Riz12(functions.channels.JoinChannelRequest(channel="@Jatt_0P"))
            await Riz12(functions.channels.JoinChannelRequest(channel="@ABOUT_PANDIT"))
    ...
    if STRING13:
        ...
        try:
            ...
            await Riz13.start()
            await Riz13(functions.channels.JoinChannelRequest(channel="@ABOUT_PANDIT"))
            await Riz13(functions.channels.JoinChannelRequest(channel="@Jatt_0P"))
    ...
    if STRING14:
        ...
        try:
            ...
            await Riz14.start()
            await Riz14(functions.channels.JoinChannelRequest(channel="@Jatt_0P"))
            await Riz14(functions.channels.JoinChannelRequest(channel="@ABOUT_PANDIT"))
    ...
    if STRING15:
        ...
        try:
            ...
            await Riz15.start()
            await Riz15(functions.channels.JoinChannelRequest(channel="@Jatt_0P"))
            await Riz15(functions.channels.JoinChannelRequest(channel="@ABOUT_PANDIT"))
    ...
    if STRING16:
        ...
        try:
            ...
            await Riz16(functions.channels.JoinChannelRequest(channel="@Jatt_0P"))
            await Riz16(functions.channels.JoinChannelRequest(channel="@ABOUT_PANDIT"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING17:
        ...
        try:
            ...
            await Riz17(functions.channels.JoinChannelRequest(channel="@ABOUT_PANDIT"))
            await Riz17(functions.channels.JoinChannelRequest(channel="@Jatt_0P"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING18:
        ...
        try:
            ...
            await Riz18(functions.channels.JoinChannelRequest(channel="@Jatt_0P"))
            await Riz18(functions.channels.JoinChannelRequest(channel="@ABOUT_PANDIT"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING19:
        ...
        try:
            ...
            await Riz19(functions.channels.JoinChannelRequest(channel="@Jatt_0P"))
            await Riz19(functions.channels.JoinChannelRequest(channel="@ABOUT_PANDIT"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING20:
        ...
        try:
            ...
            await Riz20(functions.channels.JoinChannelRequest(channel="@Jatt_0P"))
            await Riz20(functions.channels.JoinChannelRequest(channel="@ABOUT_PANDIT"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
